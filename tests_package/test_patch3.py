...
@pytest.mark.parametrize("mesh", [RectangleMesh(Point(-L,-L/2),Point(L,L/2),25,25,"crossed"),RectangleMesh(Point(-L,-L/2),Point(L,L/2),50,50,"crossed"),RectangleMesh(Point(-L,-L/2),Point(L,L/2),100,100,"crossed")])
