...
print('Min value: %.2e  Max value: %.2e   Error: %.2e' % (sigma_00.min(), sigma_00.max(), max(abs(sigma_00.max() - 4) / 4 * 100, abs(sigma_00.min() - 4) / 4 * 100)))
sigma_11 = local_project(sigma[1,1], W).vector().get_local()
#assert (np.round(sigma_11, 4) == 4).all()
print('Min value: %.2e  Max value: %.2e   Error: %.2e' % (sigma_11.min(), sigma_11.max(), max(abs(sigma_11.max() - 4) / 4 * 100, abs(sigma_11.min() - 4) / 4 * 100)))
sigma_01 = local_project(sigma[0,1], W).vector().get_local()
#assert (np.round(sigma_01, 4) == 1.5).all()
print('Min value: %.2e  Max value: %.2e   Error: %.2e' % (sigma_01.min(), sigma_01.max(), max(abs(sigma_01.max() - 1.5) / 1.5 * 100, abs(sigma_01.min() - 1.5) / 1.5 * 100)))
sigma_10 = local_project(sigma[1,0], W).vector().get_local()
#assert (np.round(sigma_10, 4) == 1.5).all()
print('Min value: %.2e  Max value: %.2e   Error: %.2e' % (sigma_10.min(), sigma_10.max(), max(abs(sigma_10.max() - 1.5) / 1.5 * 100, abs(sigma_10.min() - 1.5) / 1.5 * 100)))
#Testing moments
